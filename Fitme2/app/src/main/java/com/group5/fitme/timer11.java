...
public class timer11 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.split_jump, R.drawable.inner_thigh_lift, R.drawable.standing_kickbacks, R.drawable.reverse_trunk};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer11);
