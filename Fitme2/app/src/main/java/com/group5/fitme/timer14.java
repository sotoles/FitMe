...
public class timer14 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.tight, R.drawable.calves, R.drawable.foot_stretch, R.drawable.hip_flexions};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer14);
