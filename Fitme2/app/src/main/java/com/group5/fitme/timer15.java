...
public class timer15 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.origami_stretch, R.drawable.lower_back, R.drawable.piriformis_massage, R.drawable.calf_massage};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer15);
