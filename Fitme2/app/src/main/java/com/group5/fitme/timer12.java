...
public class timer12 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.sq, R.drawable.crunches, R.drawable.pl};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer12);
