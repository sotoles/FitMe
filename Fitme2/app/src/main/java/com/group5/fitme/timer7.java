...
public class timer7 extends AppCompatActivity {
    ...
    int i = 0;
    private int[] textureArrayWin = {R.drawable.lying_curls, R.drawable.front_back, R.drawable.swing, R.drawable.heel_beats};
