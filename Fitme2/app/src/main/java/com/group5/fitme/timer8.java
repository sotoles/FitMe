...
public class timer8 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.dumbbell_step_up, R.drawable.front_squat, R.drawable.leg_extension, R.drawable.extended_wall};
