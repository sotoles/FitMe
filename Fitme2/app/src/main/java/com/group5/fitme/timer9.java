...
public class timer9 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.walking_lunges, R.drawable.crunches, R.drawable.kettle, R.drawable.farmers_walk};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer9);
