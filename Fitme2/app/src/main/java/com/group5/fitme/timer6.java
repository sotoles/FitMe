...
public class timer6 extends AppCompatActivity {
    ...
    int i = 0;
    private int[] textureArrayWin = {R.drawable.chess_press, R.drawable.forward_weighted, R.drawable.dumbbell_bent, R.drawable.power_clean};
