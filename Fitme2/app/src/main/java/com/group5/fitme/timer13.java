...
public class timer13 extends AppCompatActivity {
    ...
    int i=0;
    private int [ ] textureArrayWin ={R.drawable.priform, R.drawable.lunge_spinal, R.drawable.triceps_stretch, R.drawable.figure_four};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer13);
